...
print("============================================================")
ascii_art = text2art("TennisAi")
print(ascii_art)
print("Tennis match winner prediction artificial intelligence")
print("============================================================")
...
for winner in predicted_winner[:1]:
    if winner == 0:
        print('The Predicted Winner is: PLAYER 1')
    else:
        print('The Predicted Winner is: PLAYER 2')
